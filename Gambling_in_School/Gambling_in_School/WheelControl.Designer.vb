...
Partial Class WheelControl
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(0, "banana.jpg")
        Me.ImageList1.Images.SetKeyName(1, "green-slot-machine-dollar-sign-vector-clipart.png")
        Me.ImageList1.Images.SetKeyName(2, "video-slot-machine-7-0000.jpg")
        '
        'Timer1
        '
